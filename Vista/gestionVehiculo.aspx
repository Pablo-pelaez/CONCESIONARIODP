<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestionVehiculo.aspx.cs" Inherits="Vista.gestionTipoVehiculo" %>
                ...
                <tr>
                    <th>
                        <asp:GridView runat="server" ID="GridView" AutoGenerateColumns="false">
                            <Columns>
                                <asp:BoundField DataField="id" HeaderText="IdTipoVehiculo"/>
